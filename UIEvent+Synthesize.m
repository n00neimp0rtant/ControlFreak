...
{
	if([self class] == objc_getClass("UITouchesEvent"))
		return [self _addGestureRecognizersForView:view toTouch:touch currentTouchMap:[NSDictionary dictionary] newTouchMap:[NSDictionary dictionary]];
	else return NO;
}
